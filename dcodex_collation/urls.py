...
urlpatterns = [
    path(
        "alignment/<int:pk>/",
        views.AlignmentDetailView.as_view(),
        name="alignment_detail_view",
    ),
    # path('family/<str:family_siglum>/<str:verse_ref>/', views.alignment_for_family, name='alignment_for_family'),
    path(
        "family/<str:family_siglum>/<str:verse_ref>/",
        views.AlignmentForFamily.as_view(),
    ...
    path(
        "alignment-pairwise-comparison/<str:siglum1>/<str:siglum2>/",
        views.pairwise_comparison,
        name="alignment-pairwise-comparison",
    ),
    path(
        "alignment-pairwise-comparison/<str:siglum1>/<str:siglum2>/csv",
        views.disagreement_transitions_csv_view,
        name="alignment-pairwise-comparison-csv",
    ),
    path(
        "alignment-pairwise-comparison/",
        views.ComparisonTableFormView.as_view(),
        name="alignment-pairwise-comparison-table",
    ),
    path("atext/", views.ATextListView.as_view(), name="atext_list"),
    path(
        "transitiontypes/",
        views.TransitionTypeListView.as_view(),
        name="transitiontype_list",
    ),
    path(
        "transitiontypes/<str:slug>/",
        views.TransitionTypeDetailView.as_view(),
        name="transitiontype_detail",
    ),
]
